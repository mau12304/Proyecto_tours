...
<script>
    ...
    <article class="detalle_paquetes">
        ...
        <div class="detalle_marco">
            ...
            <p><img src="vista/img/detalle_paquetes/ubicacion_dos.png" alt="">Visitas / Parque de la Marimba</p>
            <p><img src="vista/img/detalle_paquetes/reloj-de-bolsillo.png" alt="">Comida / Buffet</p>
        </div>
        <div class="detalle_contenido_detalle">
            ...
            <div class="detalle_del_dia">
                ...
                <h3>Día-01</h3>
                <h4><img src="vista/img/detalle_paquetes/ubicacion.png" alt="">PARQUE DE LA MARIMBA</h4>
                <p>Se planea dar un recorrido por el emblematico parque de la marimba, un lugar con musica en vivo(marimba) y baile, ademas
                    de un rico buffet en el restaurant Chiapas Magico.</p>
                </div>
            </div>
            <div class="detalle_del_dia">
                <div class="detalle_dia">
                <h3>Día-01</h3>
                <h4><img src="vista/img/detalle_paquetes/ubicacion.png" alt="">Plazas Comerciales</h4>
                <p>Para finalizar se llevara a cabo por las plazas comerciales por todo tuxtla en especial Plaza Ambar, la plaza mas lujosa de la ciudad.</p>
                </div>
            </div>
        ...
        <div class="detalle_form_contenido">
            ...
            <form action="index.php?r=reservarMarimba" method="POST" class="detalle_formulario" onsubmit="return verificarSesion()">
                ...
                <div class="detalle_form_campos3">
                    ...
                    <input type="number" id="precioPersona" name="precioPersona" value="1600" readonly>
