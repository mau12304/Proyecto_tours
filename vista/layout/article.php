<article>
        ...
        <div class="title">
            <div class="title2">
                <h1>VIVE UNA AVENTURA EXTRAORDINARIA</h1>
                <p>Vive, conoce y disfruta Chiapas, las mejores experiencias las <br> encontraras con nosotros.</p>
            </div>
        </div>
        <!--Amin-->
        <div class="act">
            <img src="vista/img/sancristobal.png" alt="sancris" class="act_imagen">
            <div class="act_contenido">
                <h2>San Cristobal: Paseo en las calles de las sombrillas</h2>
        ...
        <div class="act">
            <img src="vista/img/palenque.jpeg" alt="palenque" class="act_imagen">
            <div class="act_contenido">
                <h2>Palenque: Agua Azul, Misol Ha y Experiencia Palenque</h2>
        ...
        <div class="act">
            <img src="vista/img/zinacantan.jpeg" alt="Zinacantán" class="act_imagen">
            <div class="act_contenido">
        ...
        <div class="act">
            <img src="vista/img/cañon_sumidero.jpeg" alt="Cañon" class="act_imagen">
            <div class="act_contenido">
                <h2>Chiapa de corzo: Excursión al Cañón del Sumidero y Chiapa de Corzo</h2>
